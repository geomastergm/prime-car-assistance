...
class LoginActivity : AppCompatActivity() {
    ...
    private fun validateLogin(phone: String, password: String): Boolean {
        if (phone.isEmpty()) {
            ...
            Toast.makeText(this, "შეიყვანეთ ტელეფონის ნომერი", Toast.LENGTH_SHORT).show()
            return false
        }
        ...
        // Allow any non-empty phone and password (for testing purposes)
        // Simple validation - just check if both fields have some content

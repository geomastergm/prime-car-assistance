...
class SettingsActivity : AppCompatActivity() {
    ...
    private fun setupUI() {
        ...
        // გადახდის მეთოდების მართვა (Provider აპში ბანკის ანგარიშები)
        binding.btnManagePaymentMethods.text = "ბანკის ანგარიშების მართვა"
        binding.btnManagePaymentMethods.setOnClickListener {
            // TODO: Open Bank Accounts Management
            android.widget.Toast.makeText(this, "ბანკის ანგარიშების მართვა", android.widget.Toast.LENGTH_SHORT).show()
        }
    ...
    private fun saveProfileChanges() {
        ...
        auth.currentUser?.let { user ->
            ...
            database.getReference("providers").child(user.uid).updateChildren(updates)
        }
